...
class Apple extends AbstractProvider
{
    ...
    public function __construct(array $options = [], array $collaborators = [])
    {
        ...
        if (empty($options['keyFilePath']) and empty($options['keyFileBase64'])) {
            throw new InvalidArgumentException('Required option not passed: "keyFilePath" or "keyFileBase64"');
        }
    ...
    {
        if(!empty($this->keyFileBase64))
        {
            return new Key( base64_decode($this->keyFileBase64) );
        }
